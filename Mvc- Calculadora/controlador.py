...
class Controlador:
    ...
    def obtener_valores(self):
        ...
        n1 = float(self.vista.num1.get())
        n2 = float(self.vista.num2.get())
    ...
    def restar(self):
        ...
        resultado = self.modelo_calc.restar(a,b)
    ...
    def multiplicar(self):   
        ...
        resultado = self.modelo_calc.multiplicar(a,b)
    ...
    def division(self):
        ...
        resultado = self.modelo_calc.division(a,b)
